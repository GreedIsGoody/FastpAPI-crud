...
async def get_book(book_uid: uuid.UUID, session:AsyncSession = Depends(get_session)) -> BookModel:
...
async def update_book(book_uid: uuid.UUID, book_update_data: BookUpdateModel, session:AsyncSession = Depends(get_session)) -> BookModel:
